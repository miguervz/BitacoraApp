...
public class modificarApuntes extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modifcacionapuntes);
    ...
    public void onClick(View v) {
        if(v.getId()==(R.id.btnModificacionApuntes)){
            ...
            modifica.execute();
            Intent intent =  new Intent(modificarApuntes.this, MainActivity2.class);
    ...
    private class ModificacionRemota extends AsyncTask<Void, Void, String>
    {
        ...
        {
            Toast.makeText(modificarApuntes.this, "Modificando...",
        ...
        {
            Toast.makeText(modificarApuntes.this, "Actualizando datos...",
                    Toast.LENGTH_SHORT).show();
        }
    }
}