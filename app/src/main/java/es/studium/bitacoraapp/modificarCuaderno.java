...
public class modificarCuaderno extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v.getId()==(R.id.btnModificar)){
            ...
            modifica.execute();
            Intent intent =  new Intent(modificarCuaderno.this, MainActivity.class);
    ...
    private class ModificacionRemota extends AsyncTask<Void, Void, String>
    {
        ...
        {
            Toast.makeText(modificarCuaderno.this, "Modificando...",
        ...
        {
            Toast.makeText(modificarCuaderno.this, "Actualizando datos...",
                    Toast.LENGTH_SHORT).show();
        }
    }
