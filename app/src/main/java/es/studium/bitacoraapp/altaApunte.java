...
public class altaApunte extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v.getId()==(R.id.btnAltaApuntes)){
            ...
            altaRemota.execute();
            Intent intent =  new Intent(altaApunte.this, MainActivity2.class);
    ...
    private class AltaRemota extends AsyncTask<Void, Void, String>
    {
        ...
        {
            Toast.makeText(altaApunte.this, "Alta..."+this.textoApunte,
        ...
        protected void onPostExecute(String mensaje)
        {
            ...
            Toast.makeText(altaApunte.this, "Alta Correcta...",
                    Toast.LENGTH_SHORT).show();
        }
