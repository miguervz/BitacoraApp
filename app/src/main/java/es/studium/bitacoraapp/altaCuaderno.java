...
public class altaCuaderno extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if(v.getId()==(R.id.btnAlta)){
            ...
            altaRemota.execute();
            Intent intent =  new Intent(altaCuaderno.this, MainActivity.class);
    ...
    private class AltaRemota extends AsyncTask<Void, Void, String>
    {
        ...
        {
            Toast.makeText(altaCuaderno.this, "Alta..."+this.nombreCuaderno,
        ...
        protected void onPostExecute(String mensaje)
        {
            ...
            Toast.makeText(altaCuaderno.this, "Alta Correcta...",
                    Toast.LENGTH_SHORT).show();
        }
