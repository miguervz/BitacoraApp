...
public class MainActivity2 extends AppCompatActivity {
    ...
    private String server ="192.168.1.130";
        ...
        adapterApuntes = new AdapterApuntes(MainActivity2.this, items, new ItemClickListener() {
            ...
            public void onClick(View v, int position) {
                if(v.getId()==(R.id.imagen)){
                    idApunte = position;
                    Intent intent = new Intent(MainActivity2.this, modificarApuntes.class);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onLongClick(View view, final int position) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(MainActivity2.this)
                        ...
                        .setMessage("¿Seguro que quiere eliminar "+items.get(position).getTexto()+"?")
                        .create();
                dialog.show();
    ...
    public void altaApunte(View view){
        Intent intent = new Intent(MainActivity2.this, altaApunte.class);
        startActivity(intent);
    }
