...
public class MainActivity extends AppCompatActivity  {
    ...
    public static String server ="192.168.1.130";
        ...
        adapterCuadernos = new AdapterCuadernos(MainActivity.this, items, new ItemClickListener() {
            ...
            public void onClick(View v, int position) {
                switch (v.getId()){
                    ...
                    case R.id.imagen:
                        id = position;
                        Intent intent2 = new Intent(MainActivity.this, modificarCuaderno.class);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), recyclerView, new RecyclerTouchListener.ClickListener() {
            ...
            public void onLongClick(View view, final int position) {
                ...
                AlertDialog dialog = new AlertDialog.Builder(MainActivity.this)
                                ...
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        if(items2.size() == 0){
                                            ...
                                            builder.setMessage("Vacíe el contenido.")
                        ...
                        .setMessage("¿Seguro que quiere eliminar "+items.get(position).getCuaderno()+"?")
                        .create();
                dialog.show();
    ...
    public void altaCuaderno(View view){
        Intent intent = new Intent(MainActivity.this, altaCuaderno.class);
        startActivity(intent);
    }
